...
public class RunningSceneTwoPanel extends RunningScenePanelBase implements KeyListener {
    SceneTwoBackGround sceneTwoBackGround;
    ...
    RunningSceneTwoPanel(HeroCharacter hCharacter) {
        sceneTwoBackGround = new SceneTwoBackGround();
        heroCharacter = hCharacter;
        heroCharacter.initPosition(SceneTwoAttributes.MOVEBAL_X_MIN + 10, SceneTwoAttributes.MOVEBAL_Y_MAX);
        heroCharacter.setMovebalData(SceneTwoAttributes.MOVEBAL_X_MIN, SceneTwoAttributes.MOVEBAL_X_MAX, SceneTwoAttributes.MOVEBAL_Y_MIN, SceneTwoAttributes.MOVEBAL_Y_MAX);
        ...
        for (int i = 0; i < 7; i++) {
            ...
            zombieCharacter.setMovebalData(SceneTwoAttributes.MOVEBAL_X_MIN, SceneTwoAttributes.MOVEBAL_X_MAX, SceneTwoAttributes.MOVEBAL_Y_MIN, SceneTwoAttributes.MOVEBAL_Y_MAX);
            zombieCharacter.initPosition(1200 - (zombieCharacter.img.getWidth(null) - 90) * i,SceneTwoAttributes.MOVEBAL_Y_MAX - ((int)(Math.random()*10)) * 15);
    ...
    protected void paintComponent(Graphics g) {
        ...
        sceneTwoBackGround.drawDefault(g);
